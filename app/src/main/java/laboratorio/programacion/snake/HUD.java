...
//        controls.add(SHOOT, shoot);
    ...
    private void drawControls(Canvas c, Paint p){
        p.setColor(Color.argb(100,255,255,255)); // The value of 100 will create a transparent color.
        ...
        // Set the colors back
        // Esta es una conveniencia para que cada clase que use la referencia de Paint después no tenga que molestarse en hacerlo.
        p.setColor(Color.argb(255,255,255,255));
